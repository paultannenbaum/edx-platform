...
class Command(BaseCommand):
    ...
    Examples:
        ...
        ./manage.py reindex_course_team team1 team2 - reindexes course teams with ids team1 and team2
    ...
    def _get_course_team(self, raw_value):
        """ Parses  from string """
        try:
            result = CourseTeam.objects.get(team_id=raw_value)
        except ObjectDoesNotExist:
            raise CommandError(u"Argument {0} is not a course_team id".format(raw_value))
